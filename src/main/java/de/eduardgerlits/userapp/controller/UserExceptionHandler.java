...
public class UserExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleUserNotFoundException(UserNotFoundException ex) {
        return new ResponseEntity<>(new ApiError(HttpStatus.NOT_FOUND, ex.getMessage(), ex.getMessage()), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<ApiError> handleApiUnreachableException(ApiUnreachableException ex) {
        return new ResponseEntity<>(new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, ex.getMessage(), ex.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
